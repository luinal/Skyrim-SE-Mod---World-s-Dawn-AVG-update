...
Function InitArrays()
	...
	AgiAV[0] = "CritChance"
	AgiAV[1] = "SpeedMult"
	AgiAV[2] = "SmithingSkillAdvance"
	AgiAV[3] = "HeavyArmorSkillAdvance"
	
	DexAV[0] = "AlchemySkillAdvance"
	DexAV[1] = "PickPocketSkillAdvance"
	DexAV[2] = "LastFlattered"
	DexAV[3] = "ShieldPerks"
	...
	IntAV[1] = "EnchantingSkillAdvance"
	IntAV[2] = "AbsorbChance"
	IntAV[3] = "DestructionSkillAdvance"
	
	PerAV[0] = "FavorPointsBonus"
	PerAV[1] = "FavorsPerDay"
	PerAV[2] = "FavorActive"
	PerAV[3] = "FavorsPerDayTimer"
	
	StrAV[0] = "NightEye"
	StrAV[1] = "attackDamageMult"
	StrAV[2] = "DetectLifeRange"
	StrAV[3] = "VoicePoints"
	
	WisAV[0] = "MagickaRateMult"
	WisAV[1] = "WardDeflection"
	WisAV[2] = "LastBribedIntimidated"
