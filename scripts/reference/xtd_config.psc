...
event OnPageReset(string a_page)
    ...
    elseif (a_page == "$XTD_CharSheet")
        ...
        AddTextOption("$XTDMAGCOST", ConvertAVToText(PlayerRef, "WardDeflection", "-"), flag)
        ...
        AddTextOption("$XTDLUCKMOD", ChanceToString(PlayerRef, "FavorActive", XTDGV_MIF.GetValue(), prefix = ""), flag)
        AddTextOption("$XTDTEMPMOD", ChanceToString(PlayerRef, "FavorsPerDay", XTDGV_TIF.GetValue(), prefix = ""), flag)
        AddTextOption("$XTDAUGMMOD", ConvertAVToText(PlayerRef, "FavorsPerDayTimer", prefix = ""), flag)
		AddTextOption("$XTDGOLDMOD", ConvertAVToText(PlayerRef, "FavorPointsBonus"), flag)
		AddTextOption("$XTDBARTER", ConvertAVToText(PlayerRef, "SpeechcraftMod"), flag)
        AddHeaderOption("")
        SetCursorPosition(1)
        AddHeaderOption("$XTDStatistic")
        AddTextOption("$XTDHPS", ConvertAVToText(PlayerRef, "DetectLifeRange", suffix = ""), flag)
        AddTextOption("$XTDMPS", ConvertAVToText(PlayerRef, "EnchantingSkillAdvance", suffix = ""), flag)
        AddTextOption("$XTDMOVESPD", ConvertAVToText(PlayerRef, "SpeedMult", nativeOffset = -100.0), flag)
        AddTextOption("$XTDATCKSPD", ConvertAVToText(PlayerRef, "ShieldPerks"), flag)
        AddTextOption("$XTDMAGMIT", ConvertAVToText(PlayerRef, "LastBribedIntimidated"), flag)
        ...
        AddTextOption("$XTDCRITDMG", ConvertAVToText(PlayerRef, "VoicePoints"), flag)
        ...
        AddTextOption("$XTDBACKSTB", ConvertAVToText(PlayerRef, "SmithingSkillAdvance"), flag)
		AddTextOption("$XTDPACOST", ConvertAVToText(PlayerRef, "LastFlattered", prefix="-"), flag)
		AddTextOption("$XTDPADAMG", ConvertAVToText(PlayerRef, "PickPocketSkillAdvance"), flag) 
        ...
        AddTextOption("$XTDSKILADV", ConvertAVToText(PlayerRef, "RestorationSkillAdvance"), flag)
        ...
        AddTextOption("$XTDDAMTHRS", ConvertAVToText(PlayerRef, "VoiceRate", "", ""), flag)
        AddTextOption("$XTDOVER", ConvertAVToText(PlayerRef, "NightEye"), flag)
		AddTextOption("$XTDCA", ConvertAVToText(PlayerRef, "OneHandedSkillAdvance", prefix = ""), flag)
		AddTextOption("$XTDEXEC", ConvertAVToText(PlayerRef, "AlchemySkillAdvance"), flag)
		AddTextOption("$WDARPen", ConvertAVToText(PlayerRef, "HeavyArmorSkillAdvance"), flag)
        AddHeaderOption("")
