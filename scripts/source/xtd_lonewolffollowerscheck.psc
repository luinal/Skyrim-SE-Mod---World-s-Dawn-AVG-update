...
Function AddLoot(ObjectReference afContainer)
	...
	while (thisSlot < 0x80000000)
		...
		thisSlot *= 2
	endWhile
    If (afContainer.GetItemCount(Gold001) > 0 && PlayerRef.GetActorValue("GoldFindMod") > 0.0)
        int BonusGold = (afContainer.GetItemCount(Gold001) * (PlayerRef.GetActorValue("GoldFindMod")/ 100.0)) as int
